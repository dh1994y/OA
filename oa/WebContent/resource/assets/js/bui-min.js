...
function () {
    ...
    function () {
        ...
        return i.ATTRS = {
            ...
            __bindUI: function () {}, _uiSetAllowKeyNav: function (e) {
                var t = this,
                    i = t.get("navEvent"),
                    s = t.get("el");
            ...
            }, handleNavUp: function (e) {}, handleNavDown: function (e) {}, handleNavLeft: function (e) {}, handleNavRight: function (e) {}, handleNavEnter: function (e) {}, handleNavEsc: function (e) {}, handleNavTab: function (e) {}
        }, i
        ...
        return t.ATTRS = {
            ...
            }, getSelection: function () {}, getSelected: function () {
            ...
            }, isItemSelected: function (e) {}, isItemSelectable: function (e) {
                return !0
            ...
            }, setItemSelectedStatus: function (e, t) {}, setAllSelection: function () {}, setSelectedByField: function (e, t) {
        ...
        n.ATTRS = {
            ...
            }, getValueByField: function (e, t) {}, getItems: function () {}, getFirstItem: function () {
            ...
            }, updateItem: function (e) {}, addItem: function (e) {
                return this.addItemAt(e, this.getItemCount())
            }, addItemAt: function (e, t) {}, findItemByField: function (e, t) {}, getItemText: function (e) {}, clearItems: function () {
                var e = this,
                    t = e.getItems();
                t.splice(0), e.clearControl()
            }, removeItem: function (e) {}, removeItems: function (e) {
                var t = this;
                BUI.each(e, function (e) {
                    t.removeItem(e)
                })
        ...
        return e.ATTRS = {
            ...
            __bindUI: function () {
                ...
                if (!t) return;
                t.hasData() && e.onLoad()
            }, onBeforeLoad: function (e) {}, onLoad: function (e) {}, onException: function (e) {}, onAdd: function (e) {}, onRemove: function (e) {}, onUpdate: function (e) {}, onLocalSort: function (e) {}
        }), e
        ...
        var t = e("bui/component/uibase"),
            ...
            p = t.extend([t.Decorate, t.Tpl, t.ChildCfg, t.KeyNav, t.Depends], {
                ...
                }, handleContextMenu: function (e) {}, handleFocus: function (e) {
                ...
                }, performActionInternal: function (e) {}, destructor: function () {
                    var e = this,
    ...
    function () {
        ...
        return n.ATTRS = {
            ...
            }, getSortData: function () {}, sortData: function (e, t, n) {
                var r = this,
                    n = n || r.getSortData();
        ...
        n.ATTRS = {}, BUI.extend(n, BUI.Base), BUI.augment(n, {
            _read: function (e, t) {}, read: function (e, t, n) {
                var r = this;
                n = n || r, r._read(e, function (e) {
                    t.call(n, e)
                })
            }, _save: function (e, t, n) {}, save: function (e, t, n, r) {
                var i = this;
        ...
        return r.ATTRS = {
            ...
            }, beforeInit: function () {}, _initData: function () {
                var e = this,
                    t = e.get("autoLoad");
                t && e.load()
            }, _initParams: function () {
            ...
            }, _filterLocal: function (e) {}, _clearLocalFilter: function () {
        ...
        var t = e("bui/overlay").Overlay,
            n = t.extend({
                bindUI: function () {
                    ...
                    this._initControl()
                }, createControl: function () {}, initControlEvent: function () {
                    var e = this,
                ...
                }, setSelectedValue: function (e) {}, getSelectedValue: function () {}, getSelectedText: function () {}, focus: function () {
    ...
    function () {
        ...
        var t = e("bui/form/basefield"),
            n = t.extend({
                ...
                }, _uiSetValue: function (e) {}, _uiSetWidth: function (e) {}, _uiSetChecked: function (e) {
                    var t = this;
    ...
    function () {
        ...
        r.prototype = {
            ...
            }, showError: function (e, t, n) {}, clearErrors: function () {}
        };
        var i = function () {};
        return i.ATTRS = {
            defaultRules: {
            ...
            }, isValid: function () {}, valid: function () {}, validControl: function () {}, validRules: function (e, t) {
                if (!e) return;
                var r = this,
            ...
            }, getErrors: function () {}, showErrors: function (e) {
                var t = this,
                    e = e || t.getErrors();
        ...
        n.ATTRS = {
            ...
            getLoadingContainer: function () {}, _setLoading: function () {
                var e = this,
                    t = e.get("loadingEl"),
                    n = e.get("loadingTpl");
        ...
        return r.ATTRS = {
            ...
            }, getRemoteParams: function () {}, clearCache: function () {
                this.set("cacheMap", {})
        ...
        var t = e("bui/common"),
            ...
            i = t.Date,
            s = n.extend({
                initializer: function () {}, createControl: function () {
                    var e = this,
                        t = e.get("children"),
                        n = new r({
                            render: e.get("el"),
        ...
        return n.ATTRS = {
            ...
            __bindUI: function () {
                ...
                var e = this,
                    t = e.getInnerControl();
                t.clearErrors()
            }, getSourceValue: function () {}, updateSource: function () {}, handleNavEsc: function () {
                this.cancel()
            }, handleNavEnter: function (e) {
                var t = e.target;
    ...
    function () {
        ...
        return BUI.extend(r, BUI.Base), r.ATTRS = {
            ...
            initializer: function (e) {
            ...
            }, initEditing: function (e) {}, _getCurEditor: function () {
            ...
            }, onColumnVisibleChange: function (e) {}, getEditorCfgs: function (e) {}, getEditorConstructor: function (e) {
                return e.Editor
            ...
            }, getEditor: function (e) {}, getAlignNode: function (e) {}, getEditValue: function (e) {}, showEditor: function (e, t) {
                var n = this,
                    r = n.getEditValue(t),
                    i = n.getAlignNode(t);
                ...
                e.focus()
            }, beforeShowEditor: function (e, t) {}, _createEditOptions: function (e, t) {
                var n = this,
                    r = n.get("grid"),
                    i = r.findRow(e),
            ...
            }, getFields: function (e) {}, validRecord: function (e, t, n) {
                var r = this,
                    i = [];
            ...
            }, updateRecord: function (e, t, n) {}, _clearRowError: function (e) {
                e.find("." + n).remove()
        ...
        var t = e("bui/common"),
            ...
            o = n.OverlayView.extend({
                renderUI: function () {}, _getTitleContainer: function () {
                    return this.get("el")
                }, _uiSetTitle: function (e) {
                    var n = this,
                        r = n.get("titleTpl"),
